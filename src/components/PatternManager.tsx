    ...
    <div className="flex flex-col h-full bg-[#1E293B]/20 border border-slate-800 rounded-lg overflow-hidden select-none">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-800 bg-[#1E293B]/60">
        <div>
          ...
          <p className="text-[10px] text-slate-500 font-mono mt-0.5">Define sequential removal rules</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={addRule}
            className="flex items-center gap-1 px-2.5 py-1 bg-indigo-600 text-white rounded text-[11px] font-bold hover:bg-indigo-500 transition-colors shadow-xs cursor-pointer uppercase tracking-wider"
          >
