...
A high-performance, real-time text sanitization and multi-rule Regular Expression (RegEx) scrubber for developers, data analysts, security engineers, and privacy-conscious users.
...
Scrubadub includes an optional authentication system to support synchronization across devices.

#### Must have account to save custom rule sets
- **Free Access**: Creating an account is completely free.
- **Feature Access**: Anyone can use the core scrubber, run regex rules, use built-in rule sets, and generate rules using AI without an account. However, you **must create an account or sign in to save and manage custom rule sets** in the cloud.
- **Strict Data Privacy & Ownership Policy**:
  ...
  - All text scrubbing operations execute purely within your local browser session.

---

## Additional Resources

### RegEx Cheat Sheet (regex101.com)
...
*Scrubadub — Fast, secure, client-side text sanitization.*
